...
while ps -p 3834528 >/dev/null 2>&1; do sleep 60; done
cp syndromes_foetaux.db syndromes_foetaux.db.bak-20260913-gr
{
echo "=== $(date) extraction genereviews (limit 560)"
$PY -u extract_signes_livres.py --livre genereviews --limit 560
echo "=== $(date) mapping"
